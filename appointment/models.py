...
class Prescription(models.Model):
    ...
    # Make all foreign key fields optional
    ...
    lab_instructions = models.TextField(blank=True, null=True, help_text="Instructions for the lab technician")
    ...
    def __str__(self):
        ...
        doctor_name = f"Dr. {self.doctor.get_full_name()}" if self.doctor else "Unknown Doctor"
